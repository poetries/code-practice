...
/******/ 	var hotCurrentHash = "a056056f2a448448e2c4"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var entry = function entry() {
	    _app2.default.eventHandle();
	    var readerUI = _app2.default.readerBaseStruct(chapter_content);
	    _app2.default.readerModule().init(function (data) {
	        readerUI(data);
	    });
	    _app2.default.readerBaseStruct();
	}; // main entry
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getJonpData = __webpack_require__(6);

	var _getJonpData2 = _interopRequireDefault(_getJonpData);
	...
	var initFontSize = parseInt(_storage2.default.StorageGetter('font_size'));
	...
	var readerModule = function readerModule() {
	    ...
	    var init = function init(UIcallback) {
	        ...
	        // Promise 改善
	        getChapterInfoPromise().then(function (d) {
	    ...
	    // Promise改善异步回调操作
	    var getChapterInfoPromise = function getChapterInfoPromise() {
	        return new Promise(function (resolve, reject) {
	            $.get('/data/chapter.json', function (data) {
	                // todo获取信息的回调
	                if (data.result == 0) {
	                    // 成功的时候
	                    Chapter_id = _storage2.default.StorageGetter('last_chapter_id');
	                    if (Chapter_id == null) {
	                        Chapter_id = data.chapters[1].chapter_id;
	                    }
	                    chapterTotal = data.chapters[1].length;
	    ...
	    // Promise改善异步回调操作
	    var getCurrChapterContentPromise = function getCurrChapterContentPromise() {
	        return new Promise(function (resolve, reject) {
	            $.get('data/data' + Chapter_id + '.json', function (data) {
	                if (data.result == 0) {
	                    var url = data.jsonp;
	                    _getJonpData2.default.getData(url, function () {
	                        resolve(data);
	                    });
	                } else {
	                    reject({ msg: 'fail' });
	    ...
	    var prevChapter = function prevChapter(UIcallback) {
	        ...
	        _storage2.default.StorageSetter('last_chapter_id', Chapter_id);
	    };
	...
	exports.default = {
	    ...
	    readerBaseStruct: readerBaseStruct,
